...
export function padRaceHint(xbox: boolean): string {
  return xbox
    ? "LT brake · RT accel · L-stick steer · X slide · Y last CP · hold Y restart · LB+Y rewind · RB camera · Menu pause"
    : "L2 brake · R2 accel · L-stick steer · □ slide · △ last CP · hold △ restart · L1+△ rewind · R1 camera · Options pause";
}
